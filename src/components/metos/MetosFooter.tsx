    ...
    <footer className="bg-abyss border-t border-white/[0.06] pt-[72px] pb-10 px-6 md:px-10">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-8 md:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3.5">
            <li><a href="#" className="text-sm text-text-dim hover:text-teal transition-colors">About</a></li>
            <li><a href="#" className="text-sm text-text-dim hover:text-teal transition-colors">Research</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3.5">
            <li><a href="#" className="text-sm text-text-dim hover:text-teal transition-colors">Privacy Policy</a></li>
            <li><a href="#" className="text-sm text-text-dim hover:text-teal transition-colors">Terms of Service</a></li>
          </ul>
        </div>
      </div>
